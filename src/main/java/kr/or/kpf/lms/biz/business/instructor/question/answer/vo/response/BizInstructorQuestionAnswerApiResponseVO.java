 ...
 */
@Schema(name="BizInstructorQuestionAnswerApiResponseVO", description="강사 지원 문의 답변 API 관련 응답 객체")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BizInstructorQuestionAnswerApiResponseVO extends CSResponseVOSupport {
