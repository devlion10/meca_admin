...
/**
 * 상호평가 평가지 응답 관련 응답 객체
 */
@Schema(name="BizSurveyAnsApiResponseVO", description="상호평가 평가지 응답 API 관련 응답 객체")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BizSurveyAnsApiResponseVO extends CSResponseVOSupport {
