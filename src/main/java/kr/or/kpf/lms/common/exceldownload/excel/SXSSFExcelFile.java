...
import kr.or.kpf.lms.common.exceldownload.resource.*;
import kr.or.kpf.lms.common.exceldownload.exception.ExcelInternalException;
...
import static kr.or.kpf.lms.common.exceldownload.utils.SuperClassReflectionUtils.getField;
...
public abstract class SXSSFExcelFile<T> implements ExcelFile<T> {
    ...
    public SXSSFExcelFile(List<T> data, Class<T> type, DataFormatDecider dataFormatDecider) {
        validateData(data);
        this.wb = new SXSSFWorkbook(100000);
